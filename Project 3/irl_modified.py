...
# IMPROVED: store the min and max rewards of each reward function
R_max = [max(reward_func_1.flatten()), max(reward_func_2.flatten())]
R_min = [min(reward_func_1.flatten()), min(reward_func_2.flatten())]
...
for r_idx in range(2):
    ...
    b[r_idx] = matrix([zeros_400x1, zeros_400x1, ones_100x1 * R_max[r_idx], ones_100x1 * R_max[r_idx]])
